...
(function(){
    ...
    angular
         ...
         * TO USE EXAMPLE
         * single (string)
         *      {{'#!/parent-location/here' | is-current-location }}
         * 
         * multiple (array)
         *      {{['#!/parent-location/here', '#!/parent-location/there', '#!/parent-location/everywhere'] | is-current-location }}      
         */
        ...
        function isCurrentLocation($location){
            ...
            return function filter(_target_location, custom_class){
                ...
                if ( _target_location instanceof Array ){
                    for ( var i in _target_location ){
                        if ( checkIfCurrentLocation(_target_location[i]) )
                            return _class;
                    }
                } else if ( checkIfCurrentLocation(_target_location) ){
                    return _class;
                }
                return '';
            }
            ...
            /**
             * 
             * @param {*} _target_location 
             */
            function checkIfCurrentLocation(_target_location){
                var _current_location = $location.path();
