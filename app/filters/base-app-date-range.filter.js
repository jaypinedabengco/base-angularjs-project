...
(function(){
    ...
    angular
        ...
        .filter('baseAppDateRangeFilter', baseAppDateRangeFilter);


        baseAppDateRangeFilter.$inject = [];
        function baseAppDateRangeFilter(){

            /**
             * 
             * _items_params - list of objects ( should contain field set on _target_item_field )
